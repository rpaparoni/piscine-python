...
def test_ft_exercise(exercise_file_name):
    ...
    try:
        ...
        print("   Make sure your file exists and is in the same folder as main.py")
        ...
        if "missing" in str(error) and "required positional argument" in str(error):
            print(f"❌ Function signature error: {error}")
            print(f"   For exercise 7, make sure your function takes parameters:")
...
def main():
    """
    Main function - this runs when you execute: python3 main.py
    """
